...
const TIMEZONES = {
    ...
    // ตัวอย่าง: ถ้าไม่ต้องการแสดง Sydney ก็แค่ลบบรรทัดนี้ออก
...
function createClockElements() {
    ...
    // วนลูปตามจำนวน Time Zone ที่อยู่ใน Object TIMEZONES
...
function updateClocks() {
    ...
    // วนลูปเพื่ออัปเดตนาฬิกาทุกประเทศ
    for (const key in TIMEZONES) {
        const zone = TIMEZONES[key];
        const date = new Date();
    ...
    // --- 3. คำนวณส่วนต่างเวลา ไทย vs ญี่ปุ่น (สำหรับหัวข้อ Ayunum) ---
